...
public class Fill {
    ...
    public void fillRoundRect(Canvas c, Paint paint,
        ...
        c.drawRoundRect(left, top, right, bottom, cornerRadius, cornerRadius, paint);
    }
    ...
    public void fillRect(Canvas c, Paint paint,
        ...
        switch (mType) {
            ...
            case LINEAR_GRADIENT: {
                ...
                LinearGradient gradient = new LinearGradient(
                        (int) (gradientDirection == Direction.RIGHT ? right : gradientDirection == Direction.LEFT ? left : left),
                        (int) (gradientDirection == Direction.UP ? bottom : gradientDirection == Direction.DOWN ? top : top),
                        (int) (gradientDirection == Direction.RIGHT ? left : gradientDirection == Direction.LEFT ? right : left),
                        (int) (gradientDirection == Direction.UP ? top : gradientDirection == Direction.DOWN ? bottom : top),
                        mGradientColors,
                        mGradientPositions,
                        android.graphics.Shader.TileMode.MIRROR);
